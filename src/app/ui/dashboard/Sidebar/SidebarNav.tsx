    ...
    <>
      ...
      <ul className="list-unstyled">
        ...
        <SidebarNavGroup toggleIcon={faGear} toggleText="Configurations">
          <SidebarNavItem icon={faUserGear} href="roles">
            Roles
          </SidebarNavItem>
          <SidebarNavItem icon={faCodeBranch} href="branch">
            Branch
          </SidebarNavItem>
        </SidebarNavGroup>
        ...
        <SidebarNavItem icon={faLayerGroup} href="https://jamsolutions.co.tz">
          Contact JamSolutions
        </SidebarNavItem>
      </ul>
    </>
  );
